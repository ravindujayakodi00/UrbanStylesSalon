        ...
        <section className='login-section min-h-screen flex items-center justify-center'>
            <div className='bg-gray-100 flex rounded-2xl max-w-4xl p-3'>
                ...
                <div className='sm:w-1/2 px-12'>
                    <h2 className='mt-10 font-bold text-3xl text-[#181D31]'>Login</h2>
                    ...
                    <button className='bg-white hover:bg-gray-400 border py-2 w-full rounded-xl mt-3 flex justify-center items-center text-sm'>
